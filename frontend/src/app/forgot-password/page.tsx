  ...
  return (
    <div style={{minHeight:"100vh",display:"flex",alignItems:"center",justifyContent:"center",padding:"24px",position:"relative"}}>
      ...
      <motion.div initial={{opacity:0,y:18}} animate={{opacity:1,y:0}} transition={{duration:.5}}
        className="glass" style={{width:"100%",maxWidth:"420px",padding:"48px 40px",position:"relative",zIndex:2}}>
        <div style={{textAlign:"center",marginBottom:32}}>
          ...
          <div style={{fontSize:12,color:"var(--t3)",letterSpacing:".15em",textTransform:"uppercase"}}>
            Reset Password
          </div>
        </div>
        {error && (
        ...
        <form onSubmit={submit}>
          ...
          <div style={{marginBottom:18}}>
            ...
            <input className="input" type="password" placeholder="Min 6 characters"
              value={form.newPassword} onChange={update("newPassword")} required/>
          </div>
