          ...
          <tr>
            <td style="padding:40px;">
              ...
              <p style="margin:0 0 32px;font-size:15px;line-height:1.7;color:#9ca3af;">
                Built with artificial intelligence at its core, B.O.S.S helps businesses move beyond traditional dashboards into <strong style="color:#ffffff;">continuous operational intelligence</strong>.
              </p>
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:32px;">
                <tr>
                  <td align="center">
                    <a href="${process.env.FRONTEND_URL || 'https://boss-engine.vercel.app'}"
...
const sendPasswordResetEmail = async ({ to, firstName, resetUrl }) => {
  await resend.emails.send({
    from: 'B.O.S.S <onboarding@resend.dev>',
    to,
    subject: 'Reset your B.O.S.S password',
    html: `
      <div style="font-family:'Segoe UI',Arial,sans-serif;background:#0a0a0a;padding:40px;color:#9ca3af;">
        <h2 style="color:#ffffff;">Hi ${firstName},</h2>
        <p>We received a request to reset your password. Click the link below:</p>
        <p><a href="${resetUrl}" style="color:#6366f1;font-weight:700;">Reset my password</a></p>
        <p>This link expires in 1 hour. If you did not request a reset, ignore this email.</p>
        <p style="color:#4b5563;font-size:12px;">The B.O.S.S Team</p>
      </div>
    `,
  });
};
...
module.exports = { register, login, getMe, sendPasswordResetEmail };
